...
describe('Scrabble', () => {
  ...
  it('scores include variables for triple and double letter bonuses', () => {
    expect(scrabble('Cab[b]age')).toEqual(20)
  })

  it('scores include triple and double word bonuses', () => {
    expect(scrabble('{hotDOg}')).toEqual(22)
  })
})
